...
public interface AsyncObjectFactory<T> {
     ...
     */
    CompletableFuture<T> makeObject();
     ...
     * @see #validateObject
     */
    CompletableFuture<Void> destroyObject(T object);
     ...
     *
     * @return <code>false</code> if <code>obj</code> is not valid and should be dropped from the pool, <code>true</code>
     *         otherwise.
     */
    CompletableFuture<Boolean> validateObject(T object);
}
